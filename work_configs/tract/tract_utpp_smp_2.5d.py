...
train_pipeline = [
    ...
    # dict(type='RandomFlip', prob=0.0, direction='vertical'),
    # dict(type='RandomRotate90', prob=0.0),
...
work_dir = f'./work_dirs/tract/upp_b4_512_grd_rmept0.1_10k_2.5d_f{holdout}'
