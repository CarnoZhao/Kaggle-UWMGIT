...
albu_train_transforms = [
    # dict(type='Affine', rotate=10, translate_percent=10, scale=0.05),
    ...
    dict(type='load', filepath="./work_configs/autoalbu/pascal_voc.json")
]
train_pipeline = [
...
work_dir = f'./work_dirs/tract/ut_b4_320_grd_bs32_95_aa_f0'
