...
train_pipeline = [
    ...
    # dict(type='Mosaic', p=0.5, center=(0.35, 0.65)),
...
data = dict(
    ...
    train=dict(
        ...
        img_suffix=".png",
        seg_map_suffix='.png',
        split=f"mmseg_train/splits_notail/fold_all.txt",
        # keep_empty_prob=0.1,
        classes=classes,
        palette=palette,
...
evaluation = dict(by_epoch=False, interval=total_iters * 1000, metric=['imDice', 'mDice'], pre_eval=True)
fp16 = dict()
...
work_dir = f'./work_dirs/tract/ut_b3_512_grd_notail_2.5d_all'
