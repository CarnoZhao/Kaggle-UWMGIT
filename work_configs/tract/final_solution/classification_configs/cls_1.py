...
runner = dict(type='IterBasedRunner', max_iters=57000)
checkpoint_config = dict(by_epoch=False, interval=950, save_optimizer=False)
evaluation = dict(
    by_epoch=False, interval=1900, metric=['imDice', 'mDice'], pre_eval=True)
fp16 = dict()
# work_dir = './work_dirs/new/baseline_640_b5_bs20_case_fold1'
work_dir = './work_dirs/tract/cls_1'
gpu_ids = range(0, 2)
