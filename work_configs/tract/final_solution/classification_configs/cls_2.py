...
runner = dict(type='IterBasedRunner', max_iters=27500)
checkpoint_config = dict(by_epoch=False, interval=1375, save_optimizer=False)
evaluation = dict(
    by_epoch=False, interval=1375, metric=['imDice', 'mDice'], pre_eval=True)
fp16 = dict()
# work_dir = './work_dirs/new/baseline_640_b7_bs20_Albu_fold1'
work_dir = './work_dirs/tract/cls_2'
gpu_ids = range(0, 2)
